    ...
    <ListContainer>
      ...
      <div className="bg-white rounded-lg shadow p-6 space-y-6">
        <p className="text-sm text-gray-600">
          Суммы наград реферальной программы (iOS-приложение). Сами правила
          начисления — ниже. Изменение значений применяется в течение ~60 секунд
          (Redis-кэш TTL).
        </p>

        <div className="border border-indigo-100 bg-indigo-50/50 rounded-lg p-4 space-y-2">
          <div className="font-semibold text-gray-900">
            Правила политики — как это работает
          </div>
          <ul className="text-sm text-gray-700 space-y-1.5 list-disc pl-5">
            <li>
              <b>Один код на аккаунт.</b> Каждый пользователь может активировать
              только один реферальный код за всю историю — 1 раз и только от
              1 отправителя.
            </li>
            <li>
              <b>Нельзя свой код.</b> Активировать собственный код запрещено.
            </li>
            <li>
              <b>Награда — только после подписки (у обоих).</b> Бонус (звёзды +
              дни) начисляется лишь когда у пользователя есть оплаченная подписка:
              <ul className="list-[circle] pl-5 mt-1 space-y-1">
                <li>
                  <b>Приглашённому</b> — при вводе кода награда откладывается и
                  начисляется после его первой покупки подписки.
                </li>
                <li>
                  <b>Пригласившему</b> — награда за приглашённого начисляется,
                  когда приглашённый купит подписку (если у пригласившего
                  подписка уже есть).
                </li>
              </ul>
            </li>
            <li>
              <b>Приглашённые — без лимита.</b> Количество приглашённых не
              ограничено; от накрутки защищает само требование реальной подписки.
            </li>
            <li>
              <b>Формат кода:</b> 3 буквы + 3 цифры + 2 буквы (напр.{" "}
              <code className="font-mono">AAA111BB</code>), без букв O / I / L.
            </li>
            <li>
              <b>Суммы наград</b> задаются в полях ниже; при активации
              фиксируется снимок текущих значений (история не переписывается).
            </li>
          </ul>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FieldGroup
            ...
            description="Начисляется, когда приглашённый оформит подписку (см. правила выше). У пригласившего тоже должна быть подписка."
            disabled={loading || saving}
          >
            <NumberField
          ...
          <FieldGroup
            ...
            description="Начисляется после его первой покупки подписки (при вводе — откладывается)."
            disabled={loading || saving}
          >
            <NumberField
              label="Звёзды (очки лидерборда)"
