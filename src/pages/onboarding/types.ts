...
export const DEFAULT_SPOTLIGHT_KEYS: SpotlightKey[] = [
    ...
    { value: 'home_banner', label: 'Баннер события (карусель)' },
    { value: 'home_events', label: 'Сетка событий' },
    { value: 'home_rating_card', label: 'Карточка рейтинга' },
    { value: 'home_reward_card', label: 'Карточка наград' },
