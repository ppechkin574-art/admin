...
export const UserList: React.FC = () => {
    ...
    const handleSavePointsSettings = async (overrides?: {
        ...
        try {
            // Only send the fields this card owns (auto-reset) — the sprint
            // threshold/prize fields live on the dedicated "Спринт" admin
            // page (CRM #19) and must not be touched from here.
        ...
        <ListContainer>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 mb-4 flex flex-wrap items-center gap-4">
                ...
                <span className="text-xs text-gray-400 w-full">
                    Обнуляет очки у всех пользователей (в т.ч. скрытых из лидерборда). Сохранение перезапускает отсчёт от текущего момента. Настройки порога и приза еженедельного спринта — на странице «Турнир → Спринт».
                </span>
            </div>
